#!/usr/bin/env python3
"""
Integration tests for the Atom feed processor.

These tests require live external services and cannot run in CI:
  - Internet access to fetch real Atom feeds
  - rmapi installed and authenticated with a reMarkable Cloud account
  - DEVICE_TOKEN set in the environment

Run locally with: python tests/integration_test.py
"""
